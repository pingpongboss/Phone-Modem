...
public class PitchDetector extends Thread {
	...
	public void run() {
		...
		final short[] audio_data = new short[BUFFER_SIZE_IN_BYTES / 2];
		final double[] x_r = new double[CHUNK_SIZE_IN_SAMPLES];
		final double[] x_i = new double[CHUNK_SIZE_IN_SAMPLES];
		final FFT fft = new FFT(CHUNK_SIZE_IN_SAMPLES_POW2);
